...
namespace Contraption\Replicator;

use Contraption\Replicator\Contracts\Container as Contract;
use Contraption\Replicator\Dependencies\ClassResolver;
use Contraption\Replicator\Dependencies\FunctionResolver;
use Contraption\Replicator\Dependencies\MethodResolver;
use Contraption\Replicator\Dependencies\ObjectResolver;
use Contraption\Replicator\Dependencies\Resolver;
use Contraption\Replicator\Exceptions\ContainerException;
use Contraption\Replicator\Exceptions\NotFoundException;
use Ds\Map;
 ...
 */
class Container implements ContainerInterface, Contract
{
    /**
     * @var \Contraption\Replicator\Container
     */
     ...
     *
     * @return \Contraption\Replicator\Container
     */
    ...
    public function bind(string $id, $concrete, bool $shared = false): void
    {
        ...
        throw new ContainerException('Unable to assign dependency resolver');
    }
     ...
     *
     * @return \Contraption\Replicator\Dependencies\Resolver
     */
     ...
     * @param string $id
     *
     * @return \Contraption\Replicator\Dependencies\Resolver|null
     */
